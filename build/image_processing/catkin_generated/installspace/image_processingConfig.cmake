...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/madhan/soccer_ws/install/${idir}'.  Ask the maintainer 'nanda <nandakishore12111996@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/madhan/soccer_ws/install/lib;/home/madhan/soccer_ws/devel/lib;/opt/ros/kinetic/lib)
