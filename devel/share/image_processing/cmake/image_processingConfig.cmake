...
if("TRUE" STREQUAL "TRUE")
  set(image_processing_SOURCE_PREFIX /home/madhan/soccer_ws/src/image_processing)
  set(image_processing_DEVEL_PREFIX /home/madhan/soccer_ws/devel)
  ...
  set(image_processing_INSTALL_PREFIX /home/madhan/soccer_ws/install)
...
if(NOT "/home/madhan/soccer_ws/devel/include " STREQUAL " ")
  set(image_processing_INCLUDE_DIRS "")
  set(_include_dirs "/home/madhan/soccer_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/madhan/soccer_ws/src/image_processing/${idir}'.  Ask the maintainer 'nanda <nandakishore12111996@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/madhan/soccer_ws/devel/lib;/home/madhan/soccer_ws/devel/lib;/opt/ros/kinetic/lib)
