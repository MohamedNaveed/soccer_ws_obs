...
if("TRUE" STREQUAL "TRUE")
  set(image_processing_SOURCE_PREFIX /home/naveed/Documents/RMI/Soccerbots/soccer_ws_obs/src/image_processing)
  set(image_processing_DEVEL_PREFIX /home/naveed/Documents/RMI/Soccerbots/soccer_ws_obs/devel)
  ...
  set(image_processing_INSTALL_PREFIX /home/naveed/Documents/RMI/Soccerbots/soccer_ws_obs/install)
...
if(NOT "/home/naveed/Documents/RMI/Soccerbots/soccer_ws_obs/devel/include " STREQUAL " ")
  set(image_processing_INCLUDE_DIRS "")
  set(_include_dirs "/home/naveed/Documents/RMI/Soccerbots/soccer_ws_obs/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'nanda <nandakishore12111996@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/naveed/Documents/RMI/Soccerbots/soccer_ws_obs/src/image_processing/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/naveed/Documents/RMI/Soccerbots/soccer_ws_obs/devel/lib;/home/naveed/Documents/RMI/Soccerbots/soccer_ws_obs/devel/lib;/home/naveed/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
